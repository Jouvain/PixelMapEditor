# Graph Report - PixelMapEditor  (2026-09-01)

## Corpus Check
- Corpus is ~4 words - fits in a single context window. You may not need a graph.

## Summary
- 1 nodes · 0 edges · 1 communities (0 shown, 1 thin omitted)
...
## Knowledge Gaps
- **1 isolated node(s):** `PixelMapEditor`
...
- **What connects `PixelMapEditor` to the rest of the system?**
